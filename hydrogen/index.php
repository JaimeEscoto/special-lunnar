...
<meta name="theme-color" content="#ffffff">
	...
	<div id="fh5co-offcanvass">
		...
		<ul>
			...
			<li><a href="thegallery.php">The Gallery</a></li>
        	...
        	<div class="item">
        		<div class="animate-box">
	        		<a href="<?php echo  $post->display_src ?>" class="image-popup fh5co-board-img"
								title="<?php echo  $post->caption ?>"><img src="<?php echo  $post->display_src ?>" alt="Free HTML5 Bootstrap template"></a>
        		</div>
        		<div class="fh5co-desc">
							<table>
								<tr>
									...
									<td>
										<div class="colors<?php echo $post->code; ?>">
											<p>
